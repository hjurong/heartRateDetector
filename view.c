 ...
 *  Author: Nicolo
 *
 * PLEASE NOTE: the delays in this file are overlong. You may need to adjust them in the code 
   you write for your application so as not to slow your system down unnecessarily.
 */ 
